...
class GameStateTest(unittest.TestCase):
    ...
    def test_snake_should_move_down_on_bot(self):
        state = GameState(
            snake=[
                Position(1, 17),
                Position(1, 18),
    ...
    def test_can_turn(self):
        ...
        self.assertEqual(
            True, state.can_turn(Direction.LEFT)
        )
        self.assertEqual(
            True, state.can_turn(Direction.UP)
        )
        self.assertEqual(
            True, state.can_turn(Direction.DOWN)
        )
        self.assertEqual(
            True, state.can_turn(Direction.RIGHT)
        )